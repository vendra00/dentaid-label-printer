...
/**
 * 
 * Ask for material transfer bean. Used to generate requirement to get the material for dispensing from warehouse.
 * <p>
 * 
 * @author sujata.shinde, (c) Copyright 2020 Rockwell Automation Technologies, Inc. All Rights Reserved.
 */
public class AskForMaterialTransferObject extends BasePayload implements Serializable {
    ...
    private List<AskForMaterialObject> materials = new ArrayList<>();
     ...
     */
    public List<AskForMaterialObject> getMaterials() {
        return materials;
    }
     ...
     */
    public void setMaterials(List<AskForMaterialObject> materials) {
    ...
    public static class AskForMaterialObject implements Serializable {
